...
public class JavaEmailSender {
    ...
    final String USER_NAME = "pulakdj89@gmail.com";   //User name of the Goole(gmail) account
    final String PASSSWORD = "Zebro@11smc";  //Password of the Goole(gmail) account
    final String FROM_ADDRESS = "pulakdj89@gmail.com";  //From addresss
